...
public class PhoneCode extends RelativeLayout implements IPhoneCode {
    ...
    private Drawable tvBgNormal = getResources().getDrawable(R.drawable.background_edit_ext);

    //输入框焦点背景

    private Drawable tvBgFocus = getResources().getDrawable(R.drawable.background_edit_ext);
    ...
    public PhoneCode(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < typedArray.getIndexCount(); i++) {
            ...
            if (attr == R.styleable.PhoneCode_codeLength) {
                ...
                int mtvBgNormal = typedArray.getResourceId(attr, R.drawable.background_edit_ext);
                ...
                int mtvBgFocus = typedArray.getResourceId(attr, R.drawable.background_edit_ext);
    ...
    private void initTvBg() {
        ...
        if (!isSetTvBgNormal) {
            ...
            if (tvBgStyle == 1001)//圆圈
                ...
                mtvBgNormal = R.drawable.background_edit_ext;
        ...
        if (!isSetTvBgFocus) {
            ...
            if (tvBgStyle == 1001) //圆圈
                ...
                mtvBgFocus = R.drawable.background_edit_ext;
...
//    }
    ...
    public void setBgNormal(Drawable tvBgNormal) {
        ...
        if (tvBgNormal != null) {
            ...
            this.tvBgNormal = getResources().getDrawable(R.drawable.background_edit_ext);
