...
public class DownloadProgress extends AppCompatTextView {
    ...
    public void onRestoreInstanceState(Parcelable state) {
        ...
        DownloadProgress.SavedState ss = (DownloadProgress.SavedState) state;
    ...
    public Parcelable onSaveInstanceState() {
        ...
        return new DownloadProgress.SavedState(superState, (int) mProgress, mState, mCurrentText.toString());
    }
    ...
    public static class SavedState extends BaseSavedState {
        ...
        public static final Creator<SavedState> CREATOR = new Creator<SavedState>() {
            @Override
            public DownloadProgress.SavedState createFromParcel(Parcel in) {
                return new DownloadProgress.SavedState(in);
            }

            @Override
            public DownloadProgress.SavedState[] newArray(int size) {
                return new DownloadProgress.SavedState[size];
            }
