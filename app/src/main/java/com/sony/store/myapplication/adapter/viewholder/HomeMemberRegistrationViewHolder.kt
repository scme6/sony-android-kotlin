...
import kotlinx.android.synthetic.main.item_member_registration.view.*

class HomeMemberRegistrationViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
