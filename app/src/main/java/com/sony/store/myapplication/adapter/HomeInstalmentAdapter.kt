...
class HomeInstalmentAdapter : RecyclerView.Adapter<HomeFlashBuyChildViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HomeFlashBuyChildViewHolder {
        return HomeFlashBuyChildViewHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.item_instalment_child, parent, false)
        )
    }
